...
export const SwitchMode = () => {
    ...
    const {style, getMode, handleModeContext } = useContext(ModeContext)

    const [mode, setMode] = useState(getMode()=='light'?true:false)
    ...
    useEffect(() => {
        handleModeContext(mode)
    }, [mode])

  return (
    <div className="container">
        <label className={`toggle ${style.switch.toggleMode}`} htmlFor="switch">
            <input id="switch" className="input" type="checkbox" checked={mode} onChange={handleMode} />
            ...
            <div className="icon icon--sun sun">
                {/* <svg height="32" width="32" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
